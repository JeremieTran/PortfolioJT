<?php include 'head.html'; ?>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Création d'un logiciel de gestion d'un magasin</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Accueil</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Projet 1</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Projet 1</h6>
                            <h1 class="display-4">Création d'un logiciel de gestion d'un magasin</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/projet1.png" alt="Image">
                        <h2 class="mb-3">Description des tâches</h2>
                        <p>
                        - Création d'un planning de tâches </br>
                        - Définition de l'architecture du site </br>
                        - Création d'un Workbench afin de créer la base de donnée MySQL sous PHPMyAdmin</br>
                        - Création de la requête sql pour la création de la base de donnée.</br>
                        - Création d'un repository GIT </br>
                        - Répartition des tâches au sein de l'équipe </br>
                        - Clean du template initial à l'aide de la définition de l'architecture </br>
                        - Création des différentes pages du site </br>
                        - Sécurisation de la base de donnée et des mots de passes </br>
                        ...
                        Date : Du 01/08/2022 au 01/01/2023
                        ...
                        <!-- Début Bloc Annexe -->
                        <div class="d-flex mb-3">
                            <a href="https://github.com/MathieuNico/CaninBTS/blob/main/documentation/GuideUsers.pdf">
                            <div class="btn-icon bg-primary mr-4">
                                <i class="fa fa-2x fa-paperclip text-white"></i>
                            </div>
                            </a>
