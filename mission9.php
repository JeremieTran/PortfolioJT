<?php include 'head.html'; ?>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Installation d'un serveur d'administration</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Accueil</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Mission 9</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            ...
                            <h1 class="display-4">Installation d'un serveur d'administration</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/mission9.png" alt="Image">
                        <h2 class="mb-3">Description des tâches</h2>
                        <p>
                        - Création d'un planning de tâches </br>
                        - Mise en place d'un serveur d'administration Windows Serveur 2019</br>
                        - Mise en place de GPO et connections aux différents sessions</br>
                        - Création d'une interface web pour la gestion des GPO </br>
                        ...
                        <p> 
                        Mission effectuée principalement seul avec l'aide de mes camarades de classe ainsi que de notre professeur.                            
                        </p>
                        <h2 class="mb-3">Contexte</h2>
                        <p> 
                        Effectué à : My Digital School </br>
                        Service : Informatique et Développement Applicatif </br>
                        Date : Du 01/12/2022 au 01/05/2023
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                <br/>
                                <h4>Process Installation WServeur et GPO</h4>
                            </div>
                        </div>
                        <!-- Fin Bloc Annexe -->  
                    </div>
