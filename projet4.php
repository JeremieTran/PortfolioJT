<?php include 'head.html'; ?>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Création d'un simulateur immobilier avec Electron</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Accueil</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Projet 4</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Projet 4</h6>
                            <h1 class="display-4">Création d'un simulateur immobilier avec Electron</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/projet4.png" alt="Image">
                        <h2 class="mb-3">Description des tâches</h2>
                        <p>
                        - Création des pages HTML et CSS. </br>
                        - Installation de npm et Electron avec Visual Studio. </br>
                        - Compilation des éléments.</br>
                        ...
                        Date : Du 01/09/2023 au 30/09/2023
                        ...
                        <div class="d-flex mb-3">
                            <a href="https://github.com/JeremieTran/CalculatriceElectron.git">
