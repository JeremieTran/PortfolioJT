<?php include 'head.html'; ?>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Gérer le patrimoine informatique</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Accueil</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Domaine Compétence 1</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Domaine Compétence 1</h6>
                            <h1 class="display-4">Gérer le patrimoine informatique</h1>
                        </div>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                <h4>Mission 2 : Création d'une base de donnée en MySql</h4>
                                <p>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                <h4>Mission 5 : Réalisation d'un outil de ticketing via les outils microsoft</h4>
                                <p>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                <h4>Mission 9 : Installation d'un serveur d'administration</h4>
                                <p>
                                    ▸ Recenser et identifier les ressources numériques  </br>
                                    ▸ Mettre en place et vérifier les niveaux d’habilitation associés à un service </br>
                                    ▸ Vérifier les conditions de la continuité d’un service informatique </br>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">▸Recenser et identifier les ressources numériques</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">▸Exploiter des référentiels, normes et standards adoptés par le prestataire informatique
                            </h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">▸Mettre en place et vérifier les niveaux d’habilitation associés à un service</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
