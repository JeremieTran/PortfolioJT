<?php include 'head.html'; ?>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Travailler en mode projet</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Accueil</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Domaine Compétence 4</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Domaine Compétence 4</h6>
                            <h1 class="display-4">Travailler en mode projet</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/team-4.jpg" alt="Image">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">▸Analyser les objectifs et les modalités d’organisation d’un projet</h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">▸Planifier les activités
                            </h6>
                        </div>
                        <div class="d-flex justify-content-between px-4">
                            <h6 class="text-white my-3">▸Évaluer les indicateurs de suivi d’un projet et analyser les écarts</h6>
                        </div>
                        <!-- <div class="d-flex justify-content-between border-bottom px-4">
