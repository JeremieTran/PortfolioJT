<?php include 'head.html'; ?>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Développer la présence en ligne de l’organisation</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Accueil</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Domaine Compétence 3</p>
            </div>
                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">Domaine Compétence 3</h6>
                            <h1 class="display-4">Développer la présence en ligne de l’organisation</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/team-3.jpg" alt="Image">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                <h4>Mission 1 : Maquette Html et CSS d'un site vitrine</h4>
                                <p>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div class="mt-n1">
                                <h4>Mission 4 : Création d'un portfolio</h4>
                                <p>
                                    ▸ Participer à la valorisation de l’image de l’organisation sur les médias numériques en tenant compte du cadre juridique et des enjeux économiques </br>
                                    ▸ Référencer les services en ligne de l’organisation et mesurer leur visibilité. </br>
                                    ▸ Participer à l’évolution d’un site Web exploitant les données de l’organisation. </br>
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="bg-primary mb-5 py-3">
                        ...
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">▸Participer à la valorisation de l’image de l’organisation sur les médias numériques en tenant compte du cadre juridique et des enjeux économiques </h6>
                        </div>
                        <div class="d-flex justify-content-between border-bottom px-4">
                            <h6 class="text-white my-3">▸Référencer les services en ligne de l’organisation et mesurer leur visibilité.
                            </h6>
                        </div>
                        <div class="d-flex justify-content-between px-4">
                            <h6 class="text-white my-3">▸Participer à l’évolution d’un site Web exploitant les données de l’organisation.</h6>
                        </div>
                        <!-- <div class="d-flex justify-content-between border-bottom px-4">
