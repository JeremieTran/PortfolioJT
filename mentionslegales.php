<?php include 'head.html'; ?>
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Mentions légales</h1>
            <div class="d-inline-flex text-white mb-5">
                <p class="m-0 text-uppercase"><a class="text-white" href="">Accueil</a></p>
                <i class="fa fa-angle-double-right pt-1 px-3"></i>
                <p class="m-0 text-uppercase">Mentions Légales</p>
            </div>
        </div>
    </div>
    <!-- Header End -->
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <p>
                        Les présentes conditions générales fixent les modalités d’utilisation du service web https://jeremietran.fr
                        </p>
                        <p>
                        ...
                        <h2 class="mb-3">Éditeur et responsable de publication</h2>
                        <p> 
                        Ce blog personnel non déclaré à la CNIL est édité par Jérémie Tran.                           
                        </p>
                        ...
                        <h2 class="mb-3">Responsabilité</h2>
                        <p> 
                        L’éditeur du site met à disposition un large contenu d’informations gratuit. Il s’assure en permanence de mettre les moyens à sa disposition pour s’assurer de la qualité de ces contenus. Toutes les informations indiquées sur le site sont données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site https://jeremietran.fr ne sont pas exhaustifs. Ils sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne. il advient à l’utilisateur de s’assurer de la pertinence de ces informations au regard de sa situation. L’utilisateur s’engage donc à utiliser ces informations sous son entière responsabilité et dégage l’éditeur de toute responsabilité à cet égard. Par ailleurs, chaque partenariat est mentionné dans les articles concernés et cette transparence est également appliquée sur les réseaux sociaux.
                        </p>  
                        <h2 class="mb-3">Limitations contractuelles sur les données techniques.</h2>
                        <p> 
